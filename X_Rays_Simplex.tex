...
All three soil types A, B and C contained material varying from clay to coarse sand particles and therefore could be treated with lime and cement. There are differences in the effects from various binders (Table 3). For instance, OPC quickly starts to react with soil particles just within 2 h after mixing with soil. Most of the reaction is finished in 2 months, Fig. \ref{fig:01}. In contrast, the effects from lime are more consequent and similar to a straight line. 
